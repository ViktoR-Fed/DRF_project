...
class LessonCRUDTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.another_user = User.objects.create_user(
            email="another@test.com", password="test123"
        )
...
class SubscriptionTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(
            name="Курс для подписки", description="Описание", owner=self.user
        )

        self.another_course = Course.objects.create(
            name="Другой курс", description="Описание", owner=self.another_user
        )
    ...
    def test_subscribe_to_course(self):
        ...
        self.assertTrue(
            Subscription.objects.filter(
                user=self.another_user, course=self.course
            ).exists()
        )
